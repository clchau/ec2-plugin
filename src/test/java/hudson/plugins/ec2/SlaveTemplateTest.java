...
public class SlaveTemplateTest extends HudsonTestCase {
    ...
    public void testConfigRoundtrip() throws Exception {
        String ami = "ami1";
        SlaveTemplate orig = new SlaveTemplate(ami, "foo", "22", "default", InstanceType.LARGE, "ttt", "foo ami", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g");
        ...
        assertEqualBeans(orig, received, "ami,securityGroup,description,remoteFS,type,jvmopts");
    }
}
